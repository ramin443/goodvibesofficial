...
import 'package:goodvibesoffl/screens/initial/splashPresenter.dart';
...
class _SplashScreenState extends State<SplashScreen>
  ...
  final Trace splashTrace =
      FirebasePerformance.instance.newTrace("new splash trace");
  ...
  void initState() {
    splashTrace.start();
    splashPresenter = SplashPresenter(context)..onSplashStart();
    _getloginstatus();
    depolyanimation();
            ...
            Center(
                child: Column(
                  ...
                  PlayAnimation<Color>(
                      ...
                      duration: Duration(milliseconds: 850),
                      tween: ColorTween(
                          begin: initialcolor.withOpacity(0.5),
                          end: finalcolor), // <-- define tween
...
//                   stops: [0.0,0.5]
                  ...
                  PlayAnimation<Color>(
                      ...
                      duration: Duration(milliseconds: 850),
                      tween: ColorTween(
                          begin: initialcolor.withOpacity(0),
                          end: initialcolor),
                      builder: (context, child, value) {
                        return Container(
                          margin: EdgeInsets.only(top: screenwidth * 0.08),
                          child: SvgPicture.asset(
                            "assets/images/good vibes text.svg",
              ...
              children: [
                Container(
                    ...
                    child: PlayAnimation<Color>(
                        tween: ColorTween(
                            begin: Colors.transparent, end: Color(0xff32386a)),
                        delay: Duration(seconds: 3),
                        duration: Duration(milliseconds: 850),
                        builder: (context, child, value) {
                          return RichText(

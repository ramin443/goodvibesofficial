...
//  height: 50,
  ...
  width: screenwidth,
  margin: EdgeInsets.only(bottom: screenwidth*0.1,left:  screenwidth*0.1,right:  screenwidth*0.1),
  ...
  children: [
    GestureDetector(
        ...
        child:
    Container(child: Text("Skip",style: TextStyle(
...
//  width: screenwidth*0.128,
  ...
  //    left:screenarea*0.000199,right:screenarea*0.000199,
    left: screenwidth*0.12,right: screenwidth*0.12
          ...
          child: Image.asset("casual-life-theotherone.png",fit:
          BoxFit.cover,),
        ),
        Container(
          margin: EdgeInsets.only(
        //     top: 40
          ...
          child: Column(
            ...
            children: [
              Container(
                child: Text("Save your favorites",textAlign:TextAlign.center
                  ,style: TextStyle(
     ...
     //               top: 18
       top: screenarea*0.0000719
                ...
                child: Text("Save your favorite tracks as well as create\n"
                    "custom playlist. Get reminders and set\n"
                    "tracks to reduce stress, anxiety, stay calm,\n"
                    "daily goals to stay consistent and mindful.",textAlign:TextAlign.center
                  ,style: TextStyle(
                      letterSpacing: 0.1,
                      fontFamily: helveticaneueregular,color: Colors.white38,
                //     fontSize: 15
    ...
    return
      ...
      child: Column(
       ...
       //     top:25,
          ...
          child: Image.asset("assets/images/casual-life-3d-meditation-1@3x.png",fit:
          BoxFit.cover,),
        ),
        Container(
          ...
          child: Column(
            ...
            children: [
              GestureDetector(
                  ...
                  child:
              Container(
                child: Text("Say Hi To Your\nSelf-Care Journal",textAlign:TextAlign.center
                  ,style: TextStyle(
                      fontFamily: helveticaneuemedium,color: Colors.white,
           //           fontSize: 22
                      fontSize: screenwidth*0.0586
          ...
          //          top: 18
                ...
                child: Text("Meditation is the key to happiness,\n"
                    "productivity, and longevity. Find thousands of\n"
                    "tracks to reduce stress, anxiety, stay calm,\n"
                    "sleep better, and meditate",textAlign:TextAlign.center
                  ,style: TextStyle(
                      letterSpacing: 0.1,
                      fontFamily: helveticaneueregular,color: Colors.white38,
        //              fontSize: 15

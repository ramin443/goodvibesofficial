...
import 'package:goodvibesoffl/screens/plays/breathe.dart';
...
child:Text("Binaurial Beats",style: TextStyle(
  fontFamily: helveticaneuemedium,
  color: Color(0xff9797de),
//  fontSize: 12.5
fontSize: screenwidth*0.0333
                      ...
                      Container(
                         ...
                         //     left: 10
                          ...
                          child:Text("Cleanse Traumatic Experiences: Reconnect With Yourself,\n"
                              "Awaken Spiritual Powers - Binaurial Beats",style: TextStyle(
                              fontFamily: helveticaneueregular,
                              color: Colors.black87,
                    //          fontSize: 12
                      fontSize: screenwidth*0.032
                ...
                //    bottom: -10,
                  bottom:-screenwidth*0.0266,
                    child: Image.asset("assets/images/simpleleaf.png",
  ...
  offset: Offset(0,3)
                ...
                child: Stack(children: [
                    ...
                    child: Column(
                      ...
                      //          left:10
                        ...
                        Container(
                            ...
                            child:Text("Latest Binaurial Beats!",style: TextStyle(
                                fontFamily: helveticaneuemedium,
                                color: Color(0xff9797de),
                       //         fontSize: 12.5
                                fontSize: screenwidth*0.0333
                        ...
                        Container(
                          ...
                          //      left: 10
                            ...
                            child:Text("Attract Positive Energy (639 Hz)- Raise Your Positive\n"
                                "Vibrations-Bring Positive Changes",style: TextStyle(
                                fontFamily: helveticaneueregular,
                                color: Colors.black87,
                          //      fontSize: 12
                            fontSize: screenwidth*0.032
                  ...
                  Positioned(
                      right:0,
                      //bottom: -14,
                      bottom:- screenwidth*0.03733,

    child: Image.asset("assets/images/darkerleaf.png",
                          height:screenwidth*0.32)),
                ],),
              ),

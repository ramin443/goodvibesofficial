...
class _CalmState extends State<Calm> with SingleTickerProviderStateMixin{
                ...
                children: [
                  ClipRRect(                borderRadius: BorderRadius.all(Radius.circular(6)),
                      ...
                      Container(
                        ...
                        child: Image.asset("assets/images/calmbg.png",fit: BoxFit.cover,),
                      )),
                  Container(
                    margin: EdgeInsets.only(
                      //   left: 16
                  ...
                  Stack(children:[
                    Container(
                        ...
                        Hero(
                          tag: "calm",
                          child:
                          Image.asset("assets/images/calmbg.png",fit: BoxFit.cover,),)
                    ),
                    Container(
                      child:
